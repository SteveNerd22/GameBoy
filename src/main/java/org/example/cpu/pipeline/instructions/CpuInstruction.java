...
public abstract sealed class CpuInstruction permits Opcode_AddImmediate8, Opcode_AddIndirectHl, Opcode_AddRegister16, Opcode_AddRegister8, Opcode_AddSpImmediate8, Opcode_CB_Bit, Opcode_CB_Set, Opcode_CallImmediate16, Opcode_CcfScf, Opcode_CompareImmediate8, Opcode_CompareIndirectHl, Opcode_CompareRegister8, Opcode_Cpl, Opcode_DIEI, Opcode_Daa, Opcode_IncDecIndirectHl, Opcode_IncDecRegister16, Opcode_IncDecRegister8, Opcode_JumpAbsoluteConditional, Opcode_JumpImmediate16, Opcode_JumpRelative, Opcode_JumpRelativeConditional, Opcode_LdAIndirectBcDe, Opcode_LdAIndirectHlIncDec, Opcode_LdAIndirectImmediate16, Opcode_LdHlSpImmediateSign8, Opcode_LdIndirectBcDeA, Opcode_LdIndirectHlImmediate, Opcode_LdIndirectHlIncDecA, Opcode_LdIndirectHlReg, Opcode_LdIndirectImmediate16A, Opcode_LdIndirectImmediate16Sp, Opcode_LdRegImmediate, Opcode_LdRegIndirectHl, Opcode_LdRegReg, Opcode_LdRegisterPairImmediate16, Opcode_LdSpHl, Opcode_LdhAIndirectC, Opcode_LdhAIndirectImmediate8, Opcode_LdhIndirectCA, Opcode_LdhIndirectImmediate8A, Opcode_LogicImmediate8, Opcode_LogicIndirectHl, Opcode_LogicRegister8, Opcode_Nop, Opcode_Pop, Opcode_Prefix, Opcode_Push, Opcode_RestartAbsolute, Opcode_Return, Opcode_RotateAccumulator, Opcode_SubImmediate8, Opcode_SubIndirectHl, Opcode_SubRegister8, UnimplementedInstruction {
